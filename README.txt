...
use the below commands to execute jar files
 
  java -jar ASCIIArtInJava.jar config.properties  (use custom properties)
  java -jar ASCIIArtInJava.jar (use default properties)